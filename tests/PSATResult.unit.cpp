...
TEST_CASE( "PSATResults", "[PSAT results]" ) {
	...
	double head = 174.85, motor_field_power = 80, motor_field_current = 125.857, motor_field_voltage = 480; baselinePumpEfficiency = 80;
	...
	REQUIRE(mod.motorRatedPower_ == Approx(200));
	REQUIRE(mod.motorShaftPower_ == Approx(101.55));
	REQUIRE(mod.pumpShaftPower_ == Approx(101.55));
	REQUIRE(mod.motorEfficiency_ * 100 == Approx(95.028));
	REQUIRE(mod.motorPowerFactor_ * 100 == Approx(85.976));
	REQUIRE(mod.motorCurrent_ == Approx(102.81));
